...
s_time = time.time()
runs = 1
for i in range(runs):  # just to create different output folders
    for dataset in datasets:
        ...
        for scene in scenes:
            ...
            run_id = f"_{i+1}" if runs > 1 else ""
            opt = f"benchmarks/vggt_edge_{args.edges}{run_id}/{dataset}/{scene}/sparse"
            ...
            adjuster(
                ...
                # gt_path=gt_path,
                early_stop=True,  # to stop after second pose convergence
            )
